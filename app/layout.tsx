...
export default function RootLayout({
  ...
  return (
    <html lang="en" className='scroll-smooth'>
      <body className={`${poppins.className} relative text-paragraph bg-primary max-w-screen-2xl my-0 mx-auto`}>
        <header className="z-10 bg-primary fixed top-0 left-0 w-full h-[4rem] flex items-center justify-between">
          <nav className="flex items-center justify-between max-w-screen-2xl w-full mx-auto px-4 md:px-12">
            <Link href="/">
              <div className="w-12 md:w-14 text-secondary flex items-center justify-center">
                <PersonalLogo />
              </div>
            </Link>
